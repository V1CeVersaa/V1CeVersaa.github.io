    ...
    return (function () {
        ...
        class r {
            constructor(e, t) {
                ...
                if (i && i.start <= i.end) {
                    ...
                    let r, a
                    ;(r =
                        n > 15 ? '\u2026' + e.slice(n - 15, n) : e.slice(0, n)),
                        (a =
                            o + 15 < e.length
                                ? e.slice(o, o + 15) + '\u2026'
                                : e.slice(o)),
        ...
        class O {
            ...
            havingStyle(e) {
                return this.style === e
                    ? this
                    : this.extend({ style: e, size: H(this.textSize, e) })
            }
            havingCrampedStyle() {
            ...
            baseSizingClasses() {
                return this.size !== O.BASESIZE
                    ? ['sizing', 'reset-size' + this.size, 'size' + O.BASESIZE]
                    : []
            }
            fontMetrics() {
                return (
        ...
        const L = {
            ...
            X = function (e) {
                let t = '<' + e
                this.classes.length &&
                    (t += ' class="' + l.escape(G(this.classes)) + '"')
                let r = ''
                for (const e in this.style)
        ...
        var Ve = {
            ...
            mathsym: function (e, t, r, n) {
                return (
                    void 0 === n && (n = []),
                    'boldsymbol' === r.font && Ce(e, 'Main-Bold', t).metrics
                        ? Ne(e, 'Main-Bold', t, r, n.concat(['mathbf']))
                        : '\\' === e || 'main' === oe[t][e].font
                        ? Ne(e, 'Main-Regular', t, r, n)
                        : Ne(e, 'AMS-Regular', t, r, n.concat(['amsrm']))
                )
            },
            makeSpan: Re,
            makeSvgSpan: He,
                    ...
                    if ('individualShift' === e.positionType) {
                        ...
                        for (let e = 1; e < t.length; e++) {
                            const n = -t[e].shift - o - t[e].elem.depth,
                                s =
                                    n -
                                    (t[e - 1].elem.height + t[e - 1].elem.depth)
                            ;(o += n),
            ...
            makeOrd: function (e, t, r) {
                ...
                if (l) {
                    ...
                    if (Ce(s, e, o).metrics) return Ne(s, e, o, t, i.concat(n))
                    if (
                        ve.hasOwnProperty(s) &&
                        ...
                        for (let a = 0; a < s.length; a++)
                            r.push(Ne(s[a], e, o, t, i.concat(n)))
                        return Oe(r)
                    }
                }
                if ('mathord' === r)
                    return Ne(s, 'Math-Italic', o, t, i.concat(['mathnormal']))
                if ('textord' === r) {
                    const e = oe[o][s] && oe[o][s].font
                    if ('ams' === e) {
                        const e = Ee('amsrm', t.fontWeight, t.fontShape)
                        return Ne(
                            s,
                            e,
                            o,
                    ...
                    {
                        const e = Ee('textrm', t.fontWeight, t.fontShape)
                        return Ne(
                            s,
                            e,
                            o,
        ...
        const Pe = { number: 3, unit: 'mu' },
            Fe = { number: 4, unit: 'mu' },
            Ge = { number: 5, unit: 'mu' },
            Ue = {
                mord: { mop: Pe, mbin: Fe, mrel: Ge, minner: Pe },
                mop: { mord: Pe, mop: Pe, mrel: Ge, minner: Pe },
                mbin: { mord: Fe, mop: Fe, mopen: Fe, minner: Fe },
                mrel: { mord: Ge, mop: Ge, mopen: Ge, minner: Ge },
                mopen: {},
                mclose: { mop: Pe, mbin: Fe, mrel: Ge, minner: Pe },
                mpunct: {
                    mord: Pe,
                    mop: Pe,
                    mrel: Ge,
        ...
        const Ze = function (e) {
            ...
            Je = Ve.makeSpan,
            Qe = ['leftmost', 'mbin', 'mopen', 'mrel', 'mop', 'mpunct'],
            ...
            it = function (e, t) {
                ...
                if (r) {
                    const e = r.children
                    if (e.length) {
                        if ('right' === t) return it(e[e.length - 1], 'right')
            ...
            at = function (e, t) {
                return e
                    ? (t && (e = it(e, t)), rt[e.classes[0]] || null)
                    : null
            },
            lt = function (e, t) {
            ...
            for (let e = 0; e < n.length; e++)
                if (
                    ...
                    n[e].hasClass('newline') &&
                        (a.pop(),
                        a.length > 0 && (s.push(ct(a, t)), (a = [])),
                        s.push(n[e]))
            a.length > 0 && s.push(ct(a, t)),
                r
                    ? ((i = ct(nt(r, t, !0))), (i.classes = ['tag']), s.push(i))
                    : o && s.push(o)
            ...
            toMarkup() {
                ...
                for (const t in this.attributes)
                    Object.prototype.hasOwnProperty.call(this.attributes, t) &&
                        ...
                        (e += '"'))
                this.classes.length > 0 &&
                    (e += ' class ="' + l.escape(G(this.classes)) + '"'),
                    (e += '>')
                for (let t = 0; t < this.children.length; t++)
                    e += this.children[t].toMarkup()
        ...
        const ft = function (e, t, r) {
            ...
            yt = function (e, t) {
                ...
                return N(o, Ve.fontMap[r].fontName, n)
                    ? Ve.fontMap[r].variant
                    : null
            },
            xt = function (e, t, r) {
                if (1 === e.length) {
        ...
        const St = function (e) {
            ...
            zt = function (e, t, r) {
                const n = St(r)
                let o
                if ('mathml' === r.output) return kt(e, t, n, r.displayMode, !0)
                if ('html' === r.output) {
                    const t = mt(e, n)
        ...
        var Bt = function (e, t, r, n, o) {
                ...
                if (/fbox|color|angl/.test(t)) {
                    ...
                    const r = new K(e, { width: '100%', height: F(i) })
                    s = Ve.makeSvgSpan([], [r], o)
                }
                return (s.height = i), (s.style.height = F(i)), s
            },
            Ct = function (e) {
                const t = new gt.MathNode('mo', [
                    new gt.TextNode(At[e.replace(/^\\/, '')]),
                ])
        ...
        const Ht = (e, t) => {
            ...
            Ot = (e, t) => {
                const r = e.isStretchy
                        ? Ct(e.label)
                        : new gt.MathNode('mo', [ft(e.label, e.mode)]),
        ...
        je({
            ...
            je({
                ...
                htmlBuilder: (e, t) => {
                    ...
                    return Ve.makeSpan(['mord', 'accentunder'], [s], t)
                },
                mathmlBuilder: (e, t) => {
                    const r = Ct(e.label),
                        n = new gt.MathNode('munder', [vt(e.base, t), r])
        ...
        je({
            ...
            htmlBuilder(e, t) {
                ...
                const o = Ve.wrapFragment(ht(e.body, n, t), t),
                    s = '\\x' === e.label.slice(0, 2) ? 'x' : 'cd'
                let i
                o.classes.push(s + '-arrow-pad'),
                    e.below &&
                        ((n = t.havingStyle(r.sub())),
                        (i = Ve.wrapFragment(ht(e.below, n, t), t)),
            ...
            mathmlBuilder(e, t) {
                ...
                } else (n = Lt()), (n = new gt.MathNode('mover', [r, n]))
                return n
            },
        })
        ...
        je({
            ...
            htmlBuilder(e, t) {
                const r = t.havingStyle(t.style.sup()),
                    n = Ve.wrapFragment(ht(e.label, r, t), t)
                return (
            ...
            mathmlBuilder(e, t) {
                let r = new gt.MathNode('mrow', [vt(e.label, t)])
                return (
                    (r = new gt.MathNode('mpadded', [r])),
            ...
            je({
                ...
                htmlBuilder(e, t) {
                    const r = Ve.wrapFragment(ht(e.fragment, t), t)
                    return r.classes.push('cd-vert-arrow'), r
                },
                mathmlBuilder(e, t) {
                    return new gt.MathNode('mrow', [vt(e.fragment, t)])
                },
            }),
            je({
                type: 'textord',
                ...
                handler(e, t) {
                    let { parser: r } = e
                    const o = qt(t[0], 'ordgroup').body
                    let s = ''
                    for (let e = 0; e < o.length; e++) {
                        s += qt(o[e], 'textord').text
                    }
                    let i,
                        a = parseInt(s)
                    if (isNaN(a))
        ...
        je({
            ...
            handler(e, t) {
                let { parser: r } = e
                const n = qt(t[0], 'color-token').color,
                    o = t[1]
                return { type: 'color', mode: r.mode, color: n, body: Ke(o) }
            },
            htmlBuilder: Xt,
            mathmlBuilder: Wt,
        }),
            je({
                ...
                handler(e, t) {
                    ...
                    const o = qt(t[0], 'color-token').color
                ...
                mathmlBuilder(e, t) {
                    ...
                    return (
                        e.newLine &&
                            ...
                            e.size &&
                                r.setAttribute('height', F(P(e.size, t)))),
                        r
                    )
                },
            })
        ...
        const Zt = function (e, t, r) {
                const n = N((oe.math[e] && oe.math[e].replace) || e, t, r)
                if (!n)
                    throw new Error(
            ...
            Kt = function (e, t, r, n) {
                const o = r.havingBaseStyle(t),
                    s = Ve.makeSpan(n.concat(o.sizingClasses(r)), [e], r),
            ...
            Qt = function (e, t, r, n, o, s) {
                const i = (function (e, t, r, n) {
                    ...
                    a = Kt(
                        Ve.makeSpan(['delimsizing', 'size' + t], [i], n),
                        w.TEXT,
                        n,
                        s
                    )
            ...
            er = function (e, t, r) {
                ...
                return {
                    ...
                    elem: Ve.makeSpan(
                        ['delimsizinginner', n],
                        [Ve.makeSpan([], [Ve.makeSymbol(e, t, r)])]
                    ),
                }
            },
            tr = function (e, t, r) {
                const n = T['Size4-Regular'][e.charCodeAt(0)]
            ...
            sr = function (e, t, r, n, o, s) {
                ...
                '\\uparrow' === e
                    ...
                    ? (i = h = '\u2016')
                    : '\\updownarrow' === e
                    ? ((i = '\\uparrow'), (h = '\u23d0'), (c = '\\downarrow'))
                    : '\\Updownarrow' === e
                    ? ((i = '\\Uparrow'), (h = '\u2016'), (c = '\\Downarrow'))
                    : l.contains(nr, e)
                    ? ((h = '\u2223'), (m = 'vert'), (p = 333))
                    : l.contains(or, e)
                    ? ((h = '\u2225'), (m = 'doublevert'), (p = 556))
                    : '[' === e || '\\lbrack' === e
                    ? ((i = '\u23a1'),
                      (h = '\u23a2'),
                      (c = '\u23a3'),
                ...
                if (m.length > 0) {
                    ...
                    if ((T.push(er(c, u, o)), T.push(rr), null === a)) {
                        const e = M - g - x + 0.016
                        T.push(tr(h, e, n))
                    } else {
                ...
                return Kt(
                    Ve.makeSpan(['delimsizing', 'mult'], [C], B),
                    w.TEXT,
                    n,
                    s
                )
            ...
            br = function (e, t, r, n, o, s) {
                ...
                '<' === e || '\\lt' === e || '\u27e8' === e
                    ...
                    : ('>' !== e && '\\gt' !== e && '\u27e9' !== e) ||
                      (e = '\\rangle'),
                    (i = l.contains(cr, e) ? pr : l.contains(lr, e) ? dr : ur)
                const a = fr(e, t, i, n)
                return 'small' === a.type
                    ? (function (e, t, r, n, o, s) {
                          const i = Ve.makeSymbol(e, 'Main-Regular', o, n),
                              a = Kt(i, t, n, s)
                          return r && Jt(a, n, t), a
                      })(e, a.style, r, n, o, s)
                    : 'large' === a.type
        ...
        var yr = {
            sqrtImage: function (e, t) {
                const r = t.havingBaseSizing(),
                    n = fr('\\surd', e * r.sizeMultiplier, dr, r)
                ...
                return (
                    'small' === n.type
                        ...
                        ? ((c = 1080 * mr[n.size]),
                          (h = (mr[n.size] + s) / o),
                          (l = (mr[n.size] + s + ir) / o),
                          (i = ar('sqrtSize' + n.size, l, c, s, t)),
                          (i.style.minWidth = '1.02em'),
                          (a = 1 / o))
                        : ((l = e + s + ir),
                          (h = e + s),
                          (c = Math.floor(1e3 * e + s) + 80),
                          (i = ar('sqrtTall', l, c, s, t)),
            ...
            sizedDelim: function (e, t, r, o, s) {
                if (
                    ('<' === e || '\\lt' === e || '\u27e8' === e
                        ...
                        : ('>' !== e && '\\gt' !== e && '\u27e9' !== e) ||
                          (e = '\\rangle'),
                    l.contains(lr, e) || l.contains(cr, e))
                )
                    return Qt(e, t, !1, r, o, s)
                if (l.contains(hr, e)) return sr(e, mr[t], !1, r, o, s)
        ...
        je({
            ...
            htmlBuilder: (e, t) =>
                '.' === e.delim
                    ? Ve.makeSpan([e.mclass])
                    : yr.sizedDelim(e.delim, e.size, t, e.mode, [e.mclass]),
            mathmlBuilder: (e) => {
                const t = []
            ...
            je({
                ...
                handler: (e, t) => {
                    ...
                    const s = qt(n.parseFunction(), 'leftright-right')
                    return {
                        type: 'leftright',
                        mode: n.mode,
                        body: o,
                ...
                htmlBuilder: (e, t) => {
                    kr(e)
                    const r = nt(e.body, t, !0, ['mopen', 'mclose'])
                    let n,
                        o,
                        s = 0,
                        i = 0,
                    ...
                    if (
                        ...
                        (n =
                            '.' === e.left
                                ? lt(t, ['mopen'])
                                : yr.leftRightDelim(e.left, s, i, t, e.mode, [
                                      'mopen',
                                  ])),
                        r.unshift(n),
                        a)
                    ...
                    if ('.' === e.right) o = lt(t, ['mclose'])
                    else {
                        const r = e.rightColor ? t.withColor(e.rightColor) : t
                        o = yr.leftRightDelim(e.right, s, i, r, e.mode, [
                            'mclose',
                        ])
                    }
                    return r.push(o), Ve.makeSpan(['minner'], r, t)
                },
                mathmlBuilder: (e, t) => {
                    kr(e)
                    const r = xt(e.body, t)
                    if ('.' !== e.left) {
                        const t = new gt.MathNode('mo', [ft(e.left, e.mode)])
                        t.setAttribute('fence', 'true'), r.unshift(t)
                    }
                    if ('.' !== e.right) {
                        const t = new gt.MathNode('mo', [ft(e.right, e.mode)])
        ...
        const Sr = (e, t) => {
                ...
                if ('sout' === n)
                    ...
                    ;(o = Ve.makeSvgSpan(['hide-tail'], [m], t)),
                        (o.style.height = F(a)),
                        (i = r.depth + e + n)
                } else {
                    ;/cancel/.test(n)
                    ...
                    ;/box/.test(n)
                        ...
                        /fbox|boxed|fcolorbox/.test(n)
                            ? ((o.style.borderStyle = 'solid'),
                              (o.style.borderWidth = F(h)))
                            : 'angl' === n &&
                              0.049 !== h &&
                              ((o.style.borderTopWidth = F(h)),
                ...
                return (
                    ...
                    /cancel/.test(n) && !a
                        ? Ve.makeSpan(['mord', 'cancel-lap'], [c], t)
                        : Ve.makeSpan(['mord'], [c], t)
                )
            },
            Mr = (e, t) => {
                let r = 0
                const n = new gt.MathNode(
        ...
        je({
            ...
            handler(e, t, r) {
                let { parser: n, funcName: o } = e
                const s = qt(t[0], 'color-token').color,
                    i = t[1]
                return {
                    type: 'enclose',
                    mode: n.mode,
            ...
            static range(e, t) {
                return t
                    ? e && e.loc && t.loc && e.loc.lexer === t.loc.lexer
                        ? new Cr(e.loc.lexer, e.loc.start, t.loc.end)
                        : null
                    : e && e.loc
            }
        }
            ...
            function w() {
                y &&
                    (e.gullet.macros.get('\\df@tag')
                        ? (y.push(e.subparse([new Nr('\\df@tag')])),
        ...
        const Er = function (e, t) {
                ...
                if (e.tags && e.tags.some((e) => e))
                    for (r = 0; r < s; ++r) {
                        ...
                        ;(i =
                            !0 === s
                                ? Ve.makeSpan(['eqn-num'], [], t)
                                : !1 === s
                                ? Ve.makeSpan([], [], t)
                                : Ve.makeSpan([], nt(s, t, !0), t)),
                            (i.depth = n.depth),
                            (i.height = n.height),
                ...
                for (o = 0, A = 0; o < a || A < S.length; ++o, ++A) {
                    ...
                    for (; 'separator' === c.type; ) {
                        if (
                            ...
                            throw new n(
                                'Invalid separator type: ' + c.separator
                            )
                        {
                            const e = '|' === c.separator ? 'solid' : 'dashed',
                                r = Ve.makeSpan(['vertical-separator'], [], t)
                            ;(r.style.height = F(x)),
                ...
                if (0 === T.length) return Ve.makeSpan(['mord'], [h], t)
                {
                    let e = Ve.makeVList(
                    ...
                    return (
                        (e = Ve.makeSpan(['tag'], [e], t)),
                        Ve.makeFragment([h, e])
                    )
                }
            },
            Lr = { c: 'center ', l: 'left ', r: 'right ' },
            Dr = function (e, t) {
                const r = [],
                ...
                for (let s = 0; s < e.body.length; s++) {
                    ...
                    for (let e = 0; e < i.length; e++)
                        a.push(new gt.MathNode('mtd', [vt(i[e], t)]))
                    e.tags &&
                        e.tags[s] &&
                        (a.unshift(n),
                        a.push(n),
                ...
                return (
                    ...
                    '' !== a &&
                        ((s = new gt.MathNode('menclose', [s])),
                        s.setAttribute('notation', a.trim())),
                    e.arraystretch &&
                        e.arraystretch < 1 &&
                        ((s = new gt.MathNode('mstyle', [s])),
            ...
            Vr = function (e, t) {
                ...
                i.body.forEach(function (e) {
                    for (let t = 1; t < e.length; t += 2) {
                        ...
                        qt(r.body[0], 'ordgroup').body.unshift(h)
                    }
        ...
        Ar({
            ...
            props: { numArgs: 1 },
            handler(e, t) {
                const r = (Rt(t[0]) ? [t[0]] : qt(t[0], 'ordgroup').body).map(
                        function (e) {
                            const t = It(e).text
                            if (-1 !== 'lcr'.indexOf(t))
            ...
            Ar({
                ...
                props: { numArgs: 0 },
                handler(e) {
                    const t = Hr(e.parser, { arraystretch: 0.5 }, 'script')
            ...
            Ar({
                ...
                handler(e, t) {
                    const r = (
                        Rt(t[0]) ? [t[0]] : qt(t[0], 'ordgroup').body
                    ).map(function (e) {
                        const t = It(e).text
                        if (-1 !== 'lc'.indexOf(t))
                            return { type: 'align', align: t }
            ...
            Ar({
                ...
                props: { numArgs: 0 },
                handler(e) {
                    l.contains(['gather', 'gather*'], e.envName) && Ir(e)
                    const t = {
        ...
        je({
            ...
            handler(e, t) {
                ...
                if ('\\begin' === o) {
                    ...
                    r.expect('\\end', !1)
                    const h = r.nextToken,
                        c = qt(r.parseFunction(), 'environment')
                    if (c.name !== i)
                        throw new n(
                            'Mismatch: \\begin{' +
                                i +
            ...
            Xr = (e, t) => {
                ...
                return (
                    ...
                    Ve.makeSpan(
                        ...
                        [f, Ve.makeSpan(['mfrac'], [d]), b],
                        t
                    )
                )
            },
            Wr = (e, t) => {
                let r = new gt.MathNode('mfrac', [
                    vt(e.numer, t),
                    vt(e.denom, t),
                ])
                if (e.hasBarLine) {
        ...
        je({
            ...
            handler(e, t) {
                ...
                } else (u = qt(u, 'textord')), (p = _r[Number(u.text)])
                return {
                    type: 'genfrac',
                    mode: r.mode,
                    numer: n,
        ...
        const $r = (e, t) => {
            ...
            'supsub' === e.type
                ? ((n = e.sup
                      ? ht(e.sup, t.havingStyle(r.sup()), t)
                      : ht(e.sub, t.havingStyle(r.sub()), t)),
                  (o = qt(e.base, 'horizBrace')))
                : (o = qt(e, 'horizBrace'))
            ...
            return Ve.makeSpan(['mord', o.isOver ? 'mover' : 'munder'], [a], t)
        }
        je({
            type: 'horizBrace',
            ...
            je({
                ...
                handler: (e, t) => {
                    ...
                    return r.settings.isTrusted({ command: '\\href', url: o })
                        ? { type: 'href', mode: r.mode, href: o, body: Ke(n) }
                ...
                mathmlBuilder: (e, t) => {
                    let r = wt(e.body, t)
                    return (
                        r instanceof ut || (r = new ut('mrow', [r])),
            ...
            je({
                ...
                handler: (e, t) => {
                    ...
                    return { type: 'href', mode: r.mode, href: n, body: Ke(s) }
                },
            }),
            je({
                type: 'hbox',
                ...
                handler(e, t) {
                    let { parser: r } = e
                    return { type: 'hbox', mode: r.mode, body: Ke(t[0]) }
                },
                htmlBuilder(e, t) {
                    const r = nt(e.body, t, !1)
                    return Ve.makeFragment(r)
        ...
        je({
            ...
            handler: (e, t, r) => {
                let { parser: o } = e,
                    ...
                    l = ''
                if (r[0]) {
                    const e = qt(r[0], 'raw').string.split(',')
                    for (let t = 0; t < e.length; t++) {
                        const r = e[t].split('=')
                        if (2 === r.length) {
                            const e = r[1].trim()
            ...
            je({
                ...
                htmlBuilder: (e, t) => {
                    let r
                    'clap' === e.alignment
                        ? ((r = Ve.makeSpan([], [ht(e.body, t)])),
                          (r = Ve.makeSpan(['inner'], [r], t)))
                        : (r = Ve.makeSpan(['inner'], [ht(e.body, t)]))
                    const n = Ve.makeSpan(['fix'], [])
                    let o = Ve.makeSpan([e.alignment], [r, n], t)
                    const s = Ve.makeSpan(['strut'])
                    return (
                        (s.style.height = F(o.height + o.depth)),
                        o.depth && (s.style.verticalAlign = F(-o.depth)),
                        o.children.unshift(s),
                        (o = Ve.makeSpan(['thinbox'], [o], t)),
                        Ve.makeSpan(['mord', 'vbox'], [o], t)
                    )
                },
                mathmlBuilder: (e, t) => {
                    const r = new gt.MathNode('mpadded', [vt(e.body, t)])
                    if ('rlap' !== e.alignment) {
        ...
        const Jr = (e, t, r, n, o, s, i) => {
            ...
            en = (e, t) => {
                ...
                if (
                    ...
                    if (
                        ...
                        (a = Ve.makeSymbol(o.name, e, 'math', t, [
                            'mop',
                            'op-symbol',
                            h ? 'large-op' : 'small-op',
                        ])),
                    ...
                    for (let r = 1; r < o.name.length; r++)
                        e.push(Ve.mathsym(o.name[r], o.mode, t))
                    a = Ve.makeSpan(['mop'], e, t)
                }
                let c = 0,
                    m = 0
            ...
            tn = (e, t) => {
                let r
                if (e.symbol)
                    (r = new ut('mo', [ft(e.name, e.mode)])),
                        l.contains(Qr, e.name) &&
                    ...
                    r = e.parentIsSupSub ? new ut('mrow', [r, t]) : pt([r, t])
                }
                return r
            },
            rn = {
        ...
        je({
            ...
            mathmlBuilder: (e, t) => {
                ...
                const s = new gt.MathNode('mo', [ft('\u2061', 'text')])
                return e.parentIsSupSub
                    ? new gt.MathNode('mrow', [o, s])
                    : gt.newDocumentFragment([o, s])
            },
        }),
            Br(
                '\\operatorname',
            ...
            $e({
                ...
                htmlBuilder(e, t) {
                    return e.semisimple
                        ? Ve.makeFragment(nt(e.body, t, !1))
                        : Ve.makeSpan(['mord'], nt(e.body, t, !0), t)
                },
                mathmlBuilder(e, t) {
            ...
            je({
                ...
                htmlBuilder(e, t) {
                    ...
                    return Ve.makeSpan(['mord', 'overline'], [s], t)
                },
                mathmlBuilder(e, t) {
                    const r = new gt.MathNode('mo', [new gt.TextNode('\u203e')])
                    r.setAttribute('stretchy', 'true')
                    const n = new gt.MathNode('mover', [vt(e.body, t), r])
                    return n.setAttribute('accent', 'true'), n
                },
            }),
            je({
                ...
                handler: (e, t) => {
                    let { parser: r } = e
                    const n = t[0]
                    return { type: 'phantom', mode: r.mode, body: Ke(n) }
                },
                htmlBuilder: (e, t) => {
                    const r = nt(e.body, t.withPhantom(), !1)
                    return Ve.makeFragment(r)
                },
                mathmlBuilder: (e, t) => {
                    const r = xt(e.body, t)
            ...
            je({
                ...
                handler(e, t, r) {
                    ...
                    return {
                        type: 'rule',
                        mode: n.mode,
                        shift: o && qt(o, 'size').value,
                        width: s.value,
                        height: i.value,
                    }
                },
                htmlBuilder(e, t) {
                    const r = Ve.makeSpan(['mord', 'rule'], [], t),
                        n = P(e.width, t),
                        o = P(e.height, t),
            ...
            je({
                ...
                htmlBuilder(e, t) {
                    ...
                    if (e.index) {
                        ...
                        return Ve.makeSpan(['mord', 'sqrt'], [i, p], t)
                    }
                ...
                mathmlBuilder(e, t) {
                    ...
                    return n
                        ? new gt.MathNode('mroot', [vt(r, t), vt(n, t)])
                        : new gt.MathNode('msqrt', [vt(r, t)])
                },
            })
        const ln = {
            display: w.DISPLAY,
        ...
        $e({
            ...
            htmlBuilder(e, t) {
                ...
                if (a && h) {
                    ...
                    b = Ve.makeVList(
                        { positionType: 'individualShift', children: r },
                        t
                    )
                } else if (h) {
                ...
                return Ve.makeSpan([x], [i, Ve.makeSpan(['msupsub'], [b])], t)
            },
            mathmlBuilder(e, t) {
                let r,
                    n,
                ...
                let i
                if (
                    (e.sub && s.push(vt(e.sub, t)),
                    e.sup && s.push(vt(e.sup, t)),
                    o)
                )
                    i = r ? 'mover' : 'munder'
                else if (e.sub)
            ...
            $e({
                ...
                mathmlBuilder(e, t) {
                    const r = new gt.MathNode('mo', [ft(e.text, e.mode)])
                    if ('bin' === e.family) {
                        const n = yt(e, t)
        ...
        const hn = { mi: 'italic', mn: 'normal', mtext: 'normal' }
        $e({
            type: 'mathord',
            htmlBuilder(e, t) {
            ...
            mathmlBuilder(e, t) {
                const r = new gt.MathNode('mi', [ft(e.text, e.mode, t)]),
                    n = yt(e, t) || 'italic'
            ...
            $e({
                ...
                mathmlBuilder(e, t) {
                    ...
                    return (
                        (o =
                            'text' === e.mode
                                ? new gt.MathNode('mtext', [r])
                                : /[0-9]/.test(e.text)
                                ? new gt.MathNode('mn', [r])
                                : '\\prime' === e.text
                                ? new gt.MathNode('mo', [r])
                                : new gt.MathNode('mi', [r])),
                        n !== hn[o.type] && o.setAttribute('mathvariant', n),
                        o
                    )
                },
            })
        ...
        $e({
            ...
            htmlBuilder(e, t) {
                if (mn.hasOwnProperty(e.text)) {
                    ...
                    if ('text' === e.mode) {
                        const n = Ve.makeOrd(e, t, 'textord')
                        return n.classes.push(r), n
                    }
                    return Ve.makeSpan(
                        ['mspace', r],
                        [Ve.mathsym(e.text, e.mode, t)],
                        t
                    )
                }
                if (cn.hasOwnProperty(e.text))
                    return Ve.makeSpan(['mspace', cn[e.text]], [], t)
            ...
            mathmlBuilder(e, t) {
                ...
                return (
                    (r = new gt.MathNode('mtext', [new gt.TextNode('\xa0')])), r
                )
            },
        })
        const pn = () => {
        ...
        $e({
            type: 'tag',
            mathmlBuilder(e, t) {
                const r = new gt.MathNode('mtable', [
                    new gt.MathNode('mtr', [
                        pn(),
                        new gt.MathNode('mtd', [wt(e.body, t)]),
                        pn(),
                        new gt.MathNode('mtd', [wt(e.tag, t)]),
                    ]),
                ])
        ...
        const un = {
            ...
            gn = { '\\textit': 'textit', '\\textup': 'textup' },
            fn = (e, t) => {
                const r = e.font
                return r
                    ? un[r]
                        ? t.withTextFontFamily(un[r])
                        : dn[r]
                        ? t.withTextFontWeight(dn[r])
                        : '\\emph' === r
                        ? 'textit' === t.fontShape
                            ? t.withTextFontShape('textup')
                            : t.withTextFontShape('textit')
                        : t.withTextFontShape(gn[r])
                    : t
            }
        je({
            type: 'text',
            ...
            handler(e, t) {
                let { parser: r, funcName: n } = e
                const o = t[0]
                return { type: 'text', mode: r.mode, body: Ke(o), font: n }
            },
            htmlBuilder(e, t) {
                const r = fn(e, t),
                    n = nt(e.body, r, !0)
            ...
            je({
                ...
                htmlBuilder(e, t) {
                    ...
                    return Ve.makeSpan(['mord', 'underline'], [s], t)
                },
                mathmlBuilder(e, t) {
                    const r = new gt.MathNode('mo', [new gt.TextNode('\u203e')])
                    r.setAttribute('stretchy', 'true')
                    const n = new gt.MathNode('munder', [vt(e.body, t), r])
                    return n.setAttribute('accentunder', 'true'), n
                },
            }),
            je({
        ...
        const bn = (e) => e.body.replace(/ /g, e.star ? '\u2423' : '\xa0')
        var yn = Xe
        const xn = '[ \r\n\t]',
            wn = '(\\\\[a-zA-Z@]+)' + xn + '*',
            vn = '[\u0300-\u036f]',
        ...
        class Mn {
            constructor(e, t) {
                ;(this.input = void 0),
                    ...
                    (this.input = e),
                    (this.settings = t),
                    (this.tokenRegex = new RegExp(Sn, 'g')),
                    (this.catcodes = { '%': 14, '~': 13 })
            }
            setCatcode(e, t) {
                this.catcodes[e] = t
            ...
            lex() {
                ...
                if (t === e.length) return new Nr('EOF', new Cr(this, t, t))
                const r = this.tokenRegex.exec(e)
                if (null === r || r.index !== t)
                    throw new n(
                        "Unexpected character: '" + e[t] + "'",
                        new Nr(e[t], new Cr(this, t, t + 1))
                    )
                const o = r[6] || r[3] || (r[2] ? '\\ ' : ' ')
                ...
                return new Nr(o, new Cr(this, t, this.tokenRegex.lastIndex))
            }
        }
        class zn {
            constructor(e, t) {
        ...
        Br('\\noexpand', function (e) {
            ...
            Br('\\@ifstar', '\\@ifnextchar *{\\@firstoftwo{#1}}'),
            Br('\\TextOrMath', function (e) {
        ...
        Br('\\char', function (e) {
            ...
            if (t) {
                ...
                let s
                for (; null != (s = Tn[e.future().text]) && s < t; )
                    (o *= t), (o += s), e.popToken()
            }
            return '\\@char{' + o + '}'
        })
        ...
        Br('\\newcommand', (e) => Bn(e, !1, !0)),
            Br('\\renewcommand', (e) => Bn(e, !0, !1)),
            Br('\\providecommand', (e) => Bn(e, !0, !0)),
            Br('\\message', (e) => {
            ...
            Br('\\Bbbk', '\\Bbb{k}'),
            Br('\xb7', '\\cdotp'),
            Br('\\llap', '\\mathllap{\\textrm{#1}}'),
            Br('\\rlap', '\\mathrlap{\\textrm{#1}}'),
            Br('\\clap', '\\mathclap{\\textrm{#1}}'),
            Br('\\mathstrut', '\\vphantom{(}'),
            Br('\\underbar', '\\underline{\\text{#1}}'),
            Br(
                '\\not',
            ...
            Br('\\vdots', '\\mathord{\\varvdots\\rule{0pt}{15pt}}'),
            Br('\u22ee', '\\vdots'),
            Br('\\varGamma', '\\mathit{\\Gamma}'),
            Br('\\varDelta', '\\mathit{\\Delta}'),
            Br('\\varTheta', '\\mathit{\\Theta}'),
            Br('\\varLambda', '\\mathit{\\Lambda}'),
            Br('\\varXi', '\\mathit{\\Xi}'),
            Br('\\varPi', '\\mathit{\\Pi}'),
            Br('\\varSigma', '\\mathit{\\Sigma}'),
            Br('\\varUpsilon', '\\mathit{\\Upsilon}'),
            Br('\\varPhi', '\\mathit{\\Phi}'),
            Br('\\varPsi', '\\mathit{\\Psi}'),
            Br('\\varOmega', '\\mathit{\\Omega}'),
            Br('\\substack', '\\begin{subarray}{c}#1\\end{subarray}'),
            Br(
                '\\colon',
                '\\nobreak\\mskip2mu\\mathpunct{}\\mathchoice{\\mkern-3mu}{\\mkern-3mu}{}{}{:}\\mskip6mu\\relax'
            ),
            Br('\\boxed', '\\fbox{$\\displaystyle{#1}$}'),
            Br('\\iff', '\\DOTSB\\;\\Longleftrightarrow\\;'),
            Br('\\implies', '\\DOTSB\\;\\Longrightarrow\\;'),
            Br('\\impliedby', '\\DOTSB\\;\\Longleftarrow\\;')
        const Cn = {
            ',': '\\dotsc',
            '\\not': '\\dotsb',
            '+': '\\dotsb',
        ...
        Br('\\dots', function (e) {
            ...
            return (
                r in Cn
                    ...
                    : ('\\not' === r.slice(0, 4) ||
                          (r in oe.math &&
                              l.contains(['bin', 'rel'], oe.math[r].group))) &&
                      (t = '\\dotsb'),
                t
            )
        })
        ...
        Br('\\dotso', function (e) {
            ...
            Br('\\DOTSB', '\\relax'),
            Br('\\DOTSX', '\\relax'),
            Br('\\tmspace', '\\TextOrMath{\\kern#1#3}{\\mskip#1#2}\\relax'),
            Br('\\,', '\\tmspace+{3mu}{.1667em}'),
            Br('\\thinspace', '\\,'),
            Br('\\>', '\\mskip{4mu}'),
            Br('\\:', '\\tmspace+{4mu}{.2222em}'),
            Br('\\medspace', '\\:'),
            Br('\\;', '\\tmspace+{5mu}{.2777em}'),
            Br('\\thickspace', '\\;'),
            Br('\\!', '\\tmspace-{3mu}{.1667em}'),
            Br('\\negthinspace', '\\!'),
            ...
            Br('\\enspace', '\\kern.5em '),
            Br('\\enskip', '\\hskip.5em\\relax'),
            Br('\\quad', '\\hskip1em\\relax'),
            Br('\\qquad', '\\hskip2em\\relax'),
            Br('\\tag', '\\@ifstar\\tag@literal\\tag@paren'),
            Br('\\tag@paren', '\\tag@literal{({#1})}'),
            Br('\\tag@literal', (e) => {
        ...
        const qn = F(
            T['Main-Regular']['T'.charCodeAt(0)][1] -
                0.7 * T['Main-Regular']['A'.charCodeAt(0)][1]
        )
        Br(
            '\\LaTeX',
            ...
            Br('\\hspace', '\\@ifstar\\@hspacer\\@hspace'),
            Br('\\@hspace', '\\hskip #1\\relax'),
            Br('\\@hspacer', '\\rule{0pt}{0pt}\\hskip #1\\relax'),
            Br('\\ordinarycolon', ':'),
            Br('\\vcentcolon', '\\mathrel{\\mathop\\ordinarycolon}'),
            Br(
                '\\dblcolon',
            ...
            Br('\u2a74', '\\Coloneqq'),
            Br('\\ratio', '\\vcentcolon'),
            Br('\\coloncolon', '\\dblcolon'),
            Br('\\colonequals', '\\coloneqq'),
            Br('\\coloncolonequals', '\\Coloneqq'),
            Br('\\equalscolon', '\\eqqcolon'),
            Br('\\equalscoloncolon', '\\Eqqcolon'),
            Br('\\colonminus', '\\coloneq'),
            Br('\\coloncolonminus', '\\Coloneq'),
            Br('\\minuscolon', '\\eqcolon'),
            Br('\\minuscoloncolon', '\\Eqcolon'),
            Br('\\coloncolonapprox', '\\Colonapprox'),
            Br('\\coloncolonsim', '\\Colonsim'),
            Br(
                '\\simcolon',
            ...
            Br('\\liminf', '\\DOTSB\\operatorname*{lim\\,inf}'),
            Br('\\injlim', '\\DOTSB\\operatorname*{inj\\,lim}'),
            Br('\\projlim', '\\DOTSB\\operatorname*{proj\\,lim}'),
            Br('\\varlimsup', '\\DOTSB\\operatorname*{\\overline{lim}}'),
            Br('\\varliminf', '\\DOTSB\\operatorname*{\\underline{lim}}'),
            Br('\\varinjlim', '\\DOTSB\\operatorname*{\\underrightarrow{lim}}'),
            Br('\\varprojlim', '\\DOTSB\\operatorname*{\\underleftarrow{lim}}'),
            ...
            Br('\\varsubsetneq', '\\html@mathml{\\@varsubsetneq}{\u228a}'),
            Br('\\varsubsetneqq', '\\html@mathml{\\@varsubsetneqq}{\u2acb}'),
            Br('\\varsupsetneq', '\\html@mathml{\\@varsupsetneq}{\u228b}'),
            Br('\\varsupsetneqq', '\\html@mathml{\\@varsupsetneqq}{\u2acc}'),
            Br('\\imath', '\\html@mathml{\\@imath}{\u0131}'),
            Br('\\jmath', '\\html@mathml{\\@jmath}{\u0237}'),
            Br(
                '\\llbracket',
            ...
            Br('\\Complex', '\\mathbb{C}'),
            Br('\\Dagger', '\\ddagger'),
            Br('\\diamonds', '\\diamondsuit'),
            Br('\\empty', '\\emptyset'),
            Br('\\Epsilon', '\\mathrm{E}'),
            Br('\\Eta', '\\mathrm{H}'),
            Br('\\exist', '\\exists'),
            Br('\\harr', '\\leftrightarrow'),
            Br('\\hArr', '\\Leftrightarrow'),
            Br('\\Harr', '\\Leftrightarrow'),
            Br('\\hearts', '\\heartsuit'),
            Br('\\image', '\\Im'),
            ...
            Br('\\weierp', '\\wp'),
            Br('\\Zeta', '\\mathrm{Z}'),
            Br('\\argmin', '\\DOTSB\\operatorname*{arg\\,min}'),
            Br('\\argmax', '\\DOTSB\\operatorname*{arg\\,max}'),
            Br('\\plim', '\\DOTSB\\mathop{\\operatorname{plim}}\\limits'),
            Br('\\bra', '\\mathinner{\\langle{#1}|}'),
            Br('\\ket', '\\mathinner{|{#1}\\rangle}'),
            Br('\\braket', '\\mathinner{\\langle{#1}\\rangle}'),
            Br('\\Bra', '\\left\\langle#1\\right|'),
            Br('\\Ket', '\\left|#1\\right\\rangle')
        const In = (e) => (t) => {
        ...
        Br('\\bra@ket', In(!1)),
            ...
            Br('\\set', '\\bra@set{\\{\\,}{\\mid}{}{\\,\\}}'),
            Br('\\angln', '{\\angl n}'),
            Br('\\blue', '\\textcolor{##6495ed}{#1}'),
            Br('\\orange', '\\textcolor{##ffa500}{#1}'),
            Br('\\pink', '\\textcolor{##ff00af}{#1}'),
            Br('\\red', '\\textcolor{##df0030}{#1}'),
            Br('\\green', '\\textcolor{##28ae7b}{#1}'),
            Br('\\gray', '\\textcolor{gray}{#1}'),
            Br('\\purple', '\\textcolor{##9d38bd}{#1}'),
            Br('\\blueA', '\\textcolor{##ccfaff}{#1}'),
            Br('\\blueB', '\\textcolor{##80f6ff}{#1}'),
            Br('\\blueC', '\\textcolor{##63d9ea}{#1}'),
            Br('\\blueD', '\\textcolor{##11accd}{#1}'),
            Br('\\blueE', '\\textcolor{##0c7f99}{#1}'),
            Br('\\tealA', '\\textcolor{##94fff5}{#1}'),
            Br('\\tealB', '\\textcolor{##26edd5}{#1}'),
            Br('\\tealC', '\\textcolor{##01d1c1}{#1}'),
            Br('\\tealD', '\\textcolor{##01a995}{#1}'),
            Br('\\tealE', '\\textcolor{##208170}{#1}'),
            Br('\\greenA', '\\textcolor{##b6ffb0}{#1}'),
            Br('\\greenB', '\\textcolor{##8af281}{#1}'),
            Br('\\greenC', '\\textcolor{##74cf70}{#1}'),
            Br('\\greenD', '\\textcolor{##1fab54}{#1}'),
            Br('\\greenE', '\\textcolor{##0d923f}{#1}'),
            Br('\\goldA', '\\textcolor{##ffd0a9}{#1}'),
            Br('\\goldB', '\\textcolor{##ffbb71}{#1}'),
            Br('\\goldC', '\\textcolor{##ff9c39}{#1}'),
            Br('\\goldD', '\\textcolor{##e07d10}{#1}'),
            Br('\\goldE', '\\textcolor{##a75a05}{#1}'),
            Br('\\redA', '\\textcolor{##fca9a9}{#1}'),
            Br('\\redB', '\\textcolor{##ff8482}{#1}'),
            Br('\\redC', '\\textcolor{##f9685d}{#1}'),
            Br('\\redD', '\\textcolor{##e84d39}{#1}'),
            Br('\\redE', '\\textcolor{##bc2612}{#1}'),
            Br('\\maroonA', '\\textcolor{##ffbde0}{#1}'),
            Br('\\maroonB', '\\textcolor{##ff92c6}{#1}'),
            Br('\\maroonC', '\\textcolor{##ed5fa6}{#1}'),
            Br('\\maroonD', '\\textcolor{##ca337c}{#1}'),
            Br('\\maroonE', '\\textcolor{##9e034e}{#1}'),
            Br('\\purpleA', '\\textcolor{##ddd7ff}{#1}'),
            Br('\\purpleB', '\\textcolor{##c6b9fc}{#1}'),
            Br('\\purpleC', '\\textcolor{##aa87ff}{#1}'),
            Br('\\purpleD', '\\textcolor{##7854ab}{#1}'),
            Br('\\purpleE', '\\textcolor{##543b78}{#1}'),
            Br('\\mintA', '\\textcolor{##f5f9e8}{#1}'),
            Br('\\mintB', '\\textcolor{##edf2df}{#1}'),
            Br('\\mintC', '\\textcolor{##e0e5cc}{#1}'),
            Br('\\grayA', '\\textcolor{##f6f7f7}{#1}'),
            Br('\\grayB', '\\textcolor{##f0f1f2}{#1}'),
            Br('\\grayC', '\\textcolor{##e3e5e6}{#1}'),
            Br('\\grayD', '\\textcolor{##d6d8da}{#1}'),
            Br('\\grayE', '\\textcolor{##babec2}{#1}'),
            Br('\\grayF', '\\textcolor{##888d93}{#1}'),
            Br('\\grayG', '\\textcolor{##626569}{#1}'),
            Br('\\grayH', '\\textcolor{##3b3e40}{#1}'),
            Br('\\grayI', '\\textcolor{##21242c}{#1}'),
            Br('\\kaBlue', '\\textcolor{##314453}{#1}'),
            Br('\\kaGreen', '\\textcolor{##71B307}{#1}')
        const Rn = { '^': !0, _: !0, '\\limits': !0, '\\nolimits': !0 }
        class Hn {
            constructor(e, t, r) {
                ;(this.settings = void 0),
                    ...
                    this.feed(e),
                    (this.macros = new zn(An, t.macros)),
                    (this.mode = r),
                    (this.stack = [])
            }
            feed(e) {
        ...
        class Vn {
            constructor(e, t) {
                ;(this.mode = void 0),
                    ...
                    (this.mode = 'math'),
                    (this.gullet = new Hn(e, t, this.mode)),
                    (this.settings = t),
            ...
            parseExpression(e, t) {
                ...
                for (;;) {
                    ...
                    const n = this.fetch()
                    if (-1 !== Vn.endOfExpression.indexOf(n.text)) break
                    if (t && n.text === t) break
                    if (e && yn[n.text] && yn[n.text].infix) break
                    ...
                    if ('\\limits' === e.text || '\\nolimits' === e.text) {
                        ...
                        if (!En[e.text]) break
                        {
                            const t = On.test(e.text),
                                n = []
                            for (
                                n.push(new Nr(En[e.text])), this.consume();
                                ;
            ...
            parseGroup(e, t) {
                ...
                if ('{' === o || '\\begingroup' === o) {
                    ...
                    null == s && '\\' === o[0] && !Rn.hasOwnProperty(o))
                ) {
